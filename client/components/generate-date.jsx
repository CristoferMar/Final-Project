...
export default class GenerateDate extends React.Component {
  ...
  render() {
    const lastList = parseInt(this.state.listChoiseId);
    return (
      <>
      ...
      <div className="full-width full-height-nim-nav center-content align-center">
            ...
            className="text-box margin-bottom-7rm"
              ...
              {this.state.userLists.length &&
                this.state.userLists.map(listItem =>
                  listItem.listId === lastList
                    ? (
                      <option key={listItem.listId} value={listItem.listId} selected>
                        {listItem.listTitle}
                      </option>
                      )
        ...
        <div className="full-width">
            <button className="height-70 purple-fill click-up generate-btn">Generate Date</button>
        </div>
            ...
            <div className="form-container">
              ...
              <h2 className="margin-auto form-title">{this.state.randomDate[0].dateIdea}</h2>
                ...
                <div className="center-content space-between full-width">
                  <button className="form-btn purple-fill click" onClick={this.handleCancel}>Draw Agains</button>
      ...
      {(this.state.randomHasLoaded && !this.state.randomDate.length) &&
        <div className="form-container">
          <h3 className="form-title">This list seems to be empty.</h3>
          <p className="form-title">You can add dates/items to this list in your </p>
        </div>
